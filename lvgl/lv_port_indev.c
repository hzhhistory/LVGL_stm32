 ...
 *      DEFINES
 *********************/
#define LV_USE_INDEV_TOUCHPAD 	0x16u
...
#define LV_USE_INDEV  	LV_USE_INDEV_KEYPAD  /*我们使用宏定义这样的话我们可以实现定义LV_USE_INDEV实现使用某个代码块*/
/**********************
 *      TYPEDEFS
 **********************/
...
static void keypad_read(lv_indev_t * indev_drv, lv_indev_data_t * data)
{
    ...
    /*Get the current x and y coordinates*/
//    mouse_get_xy(&data->point.x, &data->point.y);/*此处是官方默认你拥有鼠标如果没有就直接注释掉*/
